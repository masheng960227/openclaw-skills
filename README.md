...
| 技能 | 说明 |
|------|------|
| **agent-reach** | 访问 13+ 平台（Twitter/YouTube/小红书/抖音/微信等） |
...
| 技能 | 说明 |
|------|------|
| **interface-design** | 界面设计原则和流程（网页/移动端） |
| **system-ui-design** | 系统 UI 设计（操作系统/设备界面） |
| **graphic-design** | 平面设计（排版/色彩/印刷） |
...
| **proactive-agent** | 主动代理，从被动响应到主动发现 |
...
### v1.8.0 (2026-03-10)
- ✨ 添加 agent-reach 网络访问技能
  - 支持 13+ 平台（Twitter/YouTube/小红书/抖音/微信/LinkedIn 等）
  - 网页搜索和内容提取
  - 视频字幕提取
  - 社交媒体内容访问
- 📦 技能总数达到 28 个
...
### v1.7.0 (2026-03-10)
- ✨ 添加 3 个设计技能
  - interface-design: 界面设计原则和流程
  - system-ui-design: 系统 UI 设计规范
  - graphic-design: 平面设计完整指南
- 📦 技能总数达到 27 个
- 🎨 新增设计技能类别
